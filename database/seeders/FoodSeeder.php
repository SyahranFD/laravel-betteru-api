...
class FoodSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Food::create(['name' => 'Sup Telur Jagung', 'kalori' => 217, 'lemak' => 7.41, 'karbohidrat' => 33.00, 'protein' => 8.48, 'note' => 'SSup yang menenangkan dengan telur, jagung, dan sayuran.', 'imageUrl' => 'https://www.masakapahariini.com/wp-content/uploads/2022/04/sup-jagung-telur.jpg', 'videoUrl' => 'https://youtu.be/v6nTR84Wj0k?si=mkQd-VsncP5BV25p', 'goals' => 'Menurunkan Berat Badan', 'time' => 55, 'click_count' => rand(1, 100)]);
        Food::create(['name' => 'Sup Tahu Brokoli', 'kalori' => 159, 'lemak' => 9.32, 'karbohidrat' => 8.89, 'protein' => 12.05, 'note' => 'Menu Simple Kaya Nutrisi.', 'imageUrl' => 'https://asset-2.tstatic.net/kaltim/foto/bank/images/resep-sup-brokoli-tahu.jpg', 'videoUrl' => 'https://youtu.be/Avtjc5USv8g?si=rhLwvmOyv6s9DStb', 'goals' => 'Menurunkan Berat Badan', 'time' => 20, 'click_count' => rand(1, 100)]);
...
//        Food::create(['name' => 'Pancake', 'kalori' => 297, 'lemak' => 7.82, 'karbohidrat' => 39.11, 'protein' => 18.71, 'note' => 'Sehat, enak dan mudah disiapkan', 'imageUrl' => '', 'videoUrl' => '', 'goals' => 'Menurunkan Berat Badan']);
        ...
        Food::create(['name' => 'Steak Tempe', 'kalori' => 992, 'lemak' => 43.46, 'karbohidrat' => 113.09, 'protein' => 43.39, 'note' => 'Rasa makanan yang terbuat dari tempe ini hampir menyerupai olahan daging sehingga pantas disebut sebagai Steak tempe.', 'imageUrl' => 'https://cdn0-production-images-kly.akamaized.net/O2KASnUm9Bp4vpXnKkb8cRPHesA=/0x88:999x651/1200x675/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/4141610/original/098030100_1661917718-shutterstock_2182572005.jpg', 'videoUrl' => 'https://youtu.be/ji0LcuZFoEI?si=9mknmSkzvqSEdmzg', 'goals' => 'Menaikkan Berat Badan', 'time' => 60, 'click_count' => rand(1, 100)]);
        ...
        Food::create(['name' => 'Salad Ayam', 'kalori' => 376, 'lemak' => 13.98, 'karbohidrat' => 41.39, 'protein' => 22.51, 'note' => 'Salad dengan ayam, jagung dan kentang.', 'imageUrl' => 'https://asset.kompas.com/crops/WR4Qc-MFmzIjVWLVXFvGz1DT8sg=/0x0:1000x667/1200x800/data/photo/2023/10/17/652e4b591c8f8.jpg', 'videoUrl' => 'https://youtu.be/sSxx64Ku-5c?si=jTe8ccn27FlzPP_U', 'goals' => 'Menaikkan Berat Badan', 'time' => 40, 'click_count' => rand(1, 100)]);
